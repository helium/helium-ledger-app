...
#define TOTAL_SIGN_MESSAGE_BUFFER_LENGTH \
    (PACKET_DATA_SIZE + MAX_DERIVATION_PATH_BUFFER_LENGTH)

#define MAX_MESSAGE_LENGTH \
    ROUND_TO_NEXT(TOTAL_SIGN_MESSAGE_BUFFER_LENGTH, USB_SEGMENT_SIZE)
